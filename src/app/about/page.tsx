...
const ADVANTAGES = [
  {
    icon: "🌍",
    title: "直采网络",
    desc: "与多国头部酒厂/品牌建立长期直采合作，砍掉中间环节，将成本优势与品质保障直达合作伙伴。",
  },
  {
    icon: "🏭",
    title: "自有网络",
    desc: "在中国多城市建立多模态物流运营网络，覆盖全国配送网络。", 
  },
  {
    icon: "🛡️",
    title: "合规保障",
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="space-y-6 text-base leading-8 text-gray-600">
            <p>
              Steady Stream 成立于 2018 年，是一家专注于优质酒水供应链管理的专业公司。我们致力于将全球优秀的葡萄酒与烈酒、啤酒、果酒以及潮流饮料引入中国市场，为进口商、餐饮集团、零售渠道提供从选品采购到终端配送的一站式服务。
            </p>
            <p>
              公司总部位重庆，与众多品牌建立了长期稳定的合作关系，拥有丰富的品牌运营经验和成熟的渠道网络。
            </p>
            <p className="font-medium text-primary-dark/90">
              我们相信，好的酒水能够跨越地理的界限，连接不同的文化与人群。SteadyStream 将持续深耕酒水赛道，将更多优质产品带给中国消费者。
            </p>
          </div>
        </div>
      </section>
